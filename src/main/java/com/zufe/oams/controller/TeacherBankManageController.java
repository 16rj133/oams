...
import com.zufe.oams.service.TeacherBankManageService;
import com.zufe.oams.service.TeacherPaperService;
//import com.zufe.oams.util.QiniuCloudUtil;
...
@CrossOrigin
@RestController
@RequestMapping("/api/undefined/admin")
public class TeacherBankManageController {
    ...
    public ServerResponse uploadPicture(MultipartFile file){
        try {
            ...
            try {
                //使用base64方式上传到七牛云
                //url = QiniuCloudUtil.put64image(bytes, imageName);//待解决
            } catch (Exception e) {
                e.printStackTrace();
            }
