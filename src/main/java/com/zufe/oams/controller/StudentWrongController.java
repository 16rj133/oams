...
import com.zufe.oams.service.StudentWrongService;
import com.zufe.oams.util.ServerResponse;
...
public class StudentWrongController {
    ...
    */
    ...
    /*
       获取全部收藏题目
    */
    @RequestMapping("/undefined/getAllCollections")
    ...
    /*
       通过题目类型id获取收藏题目
    */
    @RequestMapping("/undefined/getCollectionsById")
    ...
    /*
        通过answerId获取收藏单选题信息
     */
    @RequestMapping("/undefined/getSingleByAnswerId")
    ...
    /*
        通过answerId获取收藏多选题信息
     */
    @RequestMapping("/undefined/getMultipleByAnswerId")
    ...
    /*
        通过answerId获取收藏判断题信息
    */
    @RequestMapping("/undefined/getJudgeByAnswerId")
    ...
    /*
        通过answerId获取收藏填空题信息
    */
    @RequestMapping("/undefined/getFillByAnswerId")
